...
def create_image_lists(image_dir, testing_percentage, validation_percentage):
    ...
    Args:
      ...
      ation_percentage: Integer percentage of images reserved for validation.
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--output_graph',
        type=str,
        default='~/Documents/block_six/poets/tf_files/output_graph.pb',
    ...
    parser.add_argument(
        '--output_labels',
        type=str,
        default='~/Documents/block_six/poets/tf_files/output_labels.txt',
    ...
    parser.add_argument(
        '--model_dir',
        type=str,
        default='~/Documents/block_six/poets/tf_files/imagenet',
        help="""\
